...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox_UserType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Author", "Member" }));

        jLabel5.setBackground(new java.awt.Color(248, 239, 238));
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        if(username.trim().equals("") || password.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Massukkan username & password", "Input Kosong", 2);
        } else {
            try {
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "Username / Password yang anda masukkan salah!", "Wrong Account", 0);
                }
